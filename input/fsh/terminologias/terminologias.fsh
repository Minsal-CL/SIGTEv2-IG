...
ValueSet: PartesDelCuerpoSnomedVS
Id:  vs-partes-cuerpo-te
Title: "Sitios del Cuerpo"
Description: "Sitios del cuerpo códificado en Snomed"
* ^experimental = false
* ^version = "0.1"
* ^status = #active
* ^date = "2023-01-15"
...
* include codes from system http://snomed.info/sct where concept is-a #442083009